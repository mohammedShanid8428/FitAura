  ...
  return (
    <section className="bg-gray-800">
      <div className="p-6 md:p-10 bg-gray-800 min-h-screen">
        <h2 className="text-3xl md:text-4xl font-bold text-center mb-8">💾 Saved Meals</h2>
        ...
        {savedMeals.length === 0 ? (
          ...
          <div className="space-y-8">
            {mealTypeOrder.map((mealType) => {
              ...
              return (
                <div key={mealType} className="bg-gray-100 rounded-lg p-6">
                  ...
                  <div className="overflow-x-auto">
                    <div className="flex gap-4 min-w-full">
                      {mealsInCategory.map((meal) => (
                        <div key={meal._id} className="min-w-[250px]">
