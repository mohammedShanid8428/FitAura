...
const buttonVariants = cva(
  "inline-flex items-center justify-center rounded-md text-sm font-medium transition-colors outline-none focus:outline-none focus:ring-0 ring-0 focus-visible:ring-0 disabled:opacity-50 disabled:pointer-events-none",
  {
    variants: {
      variant: {
        default: "bg-gray-800 text-white hover:bg-green-700 rounded-[140px] px-6 border border-gray-200",
        outline: "border border-gray-200  hover:bg-gray-100 text-gray-800 rounded-[140px] px-6 text-black ",
        // ghost: "bg-transparent hover:bg-gray-100",
      },
      size: {
        sm: "h-10 px-3 text-md",
