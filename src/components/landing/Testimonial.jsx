  ...
  return(
    <section className="py-16 px-4 max-w-6xl mx-auto mb-10">
      <div className="grid md:grid-cols-3 gap-8 items-start">
       <div>
         <p className="uppercase text-sm tracking-wide text-gray-500 mb-8 ">Testimonials</p>
         <h2 className="text-3xl md:text-4xl font-bold tracking-wide text-gray-800 mb-6">
          What Our Clients Are Saying
         </h2>
         <p className="text-gray-600 mb-10 text-lg max-w-xs">
