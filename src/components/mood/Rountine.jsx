    ...
    <section className="py-16 px-6">
      ...
      <div className="grid sm:grid-cols-2 md:grid-cols-2 lg:grid-cols-4 gap-6">
        {tips.map((tip, index) => (
          <div
            key={index}
            className="bg-gradient-to-br from-orange-50 via-white to-lime-50 border border-orange-200 rounded-xl p-5 shadow-sm hover:shadow-lg transition"
          >
      ...
      <div className="text-center mt-10">
        <button className="bg-lime-600 text-white px-6 py-2 rounded-full hover:bg-lime-700 transition">
          Explore Tips
        </button>
      </div>
    </section>
